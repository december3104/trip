...
//------------------------------------------------------------
	...
	public GuideDetail(String loc_name, String guide_contry, String guide_address, String guide_service, String guide_lang,
		...
		int car_number, String guide_qualification, String guide_id) {
	super();
	...
	public String toString() {
		return "GuideDetail [loc_name=" + loc_name + ", guide_contry=" + guide_contry + ", guide_address="
				+ guide_address + ", guide_service=" + guide_service + ", guide_lang=" + guide_lang + ", member_name="
				+ member_name + ", member_gender=" + member_gender + ", member_birth=" + member_birth + ", guide_phone="
				+ guide_phone + ", car_check=" + car_check + ", car_number=" + car_number + ", guide_qualification="
				+ guide_qualification + ", guide_id=" + guide_id + "]";
	}
