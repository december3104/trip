...
public class GuideReport implements Serializable{
	private static final long serialVersionUID =  6444L;
	...
	public GuideReport(String member_name, int report_no, String clame_id, String report_id, String report_content,
	...
	public String toString() {
		return "GuideReport [member_name=" + member_name + ", report_no=" + report_no + ", clame_id=" + clame_id
