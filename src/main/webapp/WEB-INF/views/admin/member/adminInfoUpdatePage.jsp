...
<div class="bodyCss" style="margin-left: 10%; margin-right: 10%">
	<div style="float:left; margin-left: 15%; margin-right: 15%; width: 70%">
		<h2 style="font-family: GodoM">내 정보 수정</h2>
		<hr style="border: 3px solid #95d6f3; margin-bottom: 0px">
		<div>
			<form action="adminUpdateMember.ad" method="POST" onsubmit="return updateMemberChk();"  enctype="multipart/form-data">
				<table class="ui table" style="width: 100%; vertical-align: middle; border: 0; margin-top: 2%; border: 0">
					...
					<tr>
						<th style="font-size: 13pt">이메일 주소</th>
						<td style="border-top: 0; font-size: 13pt">${loginMember.member_email }</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="border-top: 0; font-size: 13pt">${loginMember.member_phone }</td>
					</tr>
					<tr>
