		...
		<div>
			...
			<table class="ui table" style="border:none;">
				...
				<tr style="font-size: 13pt;">
					<th>현 거주지 주소</th>
					<td style="border-top:0;">
						<c:out value="${guide.guide_address }" />
					</td>
				</tr>
				...
				<tr style="font-size: 13pt;">
					<th>가능 서비스</th>
					<td style="border-top:0;">
						<c:out value="${guide.guide_service }" />
					</td>
				</tr>
				...
				<c:if test="${guide.car_check ne 'N' }">
					<tr style="font-size: 13pt;">
						<th>본인차량 유무</th>
						<td style="border-top:0;">
							<c:out value="${guide.car_check }" /> - <c:out value="${guide.car_number }" />
						</td>
					</tr>
				</c:if>
			</table>
			<div style="text-align: center;">
				<a href="updateDetailForcedExitGuide.ad?guide_id=${guide.guide_id }"><input class="ui button" style="background:#c0e7f8;" type="submit" value="자격박탈"></a> &emsp;&emsp;
