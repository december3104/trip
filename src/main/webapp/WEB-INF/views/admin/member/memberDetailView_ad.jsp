	...
	<div class="bodyContentCss">
		<div>
			...
			<div style="text-align: center;">
				...
				<a href="deleteDetailForcedExitMember.ad?member_id=${member.member_id }"><input class="ui button" style="background:#c0e7f8;" type="submit" value="강제탈퇴"></a> &emsp;&emsp;
