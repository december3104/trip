...
<body>
	...
	<div class="ui container" style="margin:120px 0 120px 0;">
		<div class="ui grid">
			...
			<div class="fourteen wide column"><h1>공지사항 글 수정</h1></div>
			<div class="one wide column"></div>
		</div>	
		<div class="ui grid">
			<div class="one wide column"></div>		
			<div class="fourteen wide column">
				<div class="ui card" style="width:auto;">
					<div class="card"> 
						<div class="content">
							<form class="ui form" action="updateDetailNotice.ad" method="post">
								...
								<div style="margin : 30px">
									...
									<div class="field">
										...
										<div style="border:1px solid rgba(34,36,38,.15);">
											<textarea id="notice_content" name="notice_content" cols="10" rows="30"  >${notice.notice_content }</textarea>
										</div>
									</div>
									<!-- 첨부파일 추가해야함. -->
