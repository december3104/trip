...
<div class="container" style="margin-top: 3%">
	<h2><font color="#95d6f3">여길잡아</font> 회원가입</h2>
	...
	<div class="table-responsive">
		<form onsubmit="return checkForm()" action="insertMember.do" method="POST" enctype="multipart/form-data">
			<table class="table" id="memberEnrollTable" style="border: none;">
				<tr style="border-top: hidden">
					<th><i class="fas fa-check"></i>&nbsp;이름</th>
						<td>
							<div class="form-group">
								<input class="form-control" type="text" placeholder="이름을 입력해주세요." name="member_name" id="member_name" />
							</div>
						</td>
				</tr>
				<tr>
					<th><i class="fas fa-check"></i>&nbsp;아이디</th>
						<td>
							<div class="form-group">
								<input class="form-control" type="text" placeholder="아이디를 입력해주세요." name="member_id" id="member_id" /> 	
				...
				<tr>
					<th><i class="fas fa-check"></i>&nbsp;비밀번호</th>
						<td>
							<div class="form-group">
								<input class="form-control" type="password" placeholder="비밀번호를 입력해주세요." name="member_pwd" id="member_pwd" />
				...
				<tr>
					<th><i class="fas fa-check"></i>&nbsp;비밀번호 확인</th>
						<td>
							<div class="form-group">
								<input class="form-control" type="password" placeholder="비밀번호를 한번 더 입력해주세요." id="member_pwd2" />
							</div>
						</td>
				</tr>
				<tr>
					<th><i class="fas fa-check"></i>&nbsp;이메일 주소</th>
						<td>
							<div class="form-group">
								<input class="form-control" type="email" placeholder="이메일 주소를 입력해주세요." name="member_email" id="member_email" />
					...
					<th><i class="fas fa-check"></i>&nbsp;성별</th>
						<td>
							<div class="custom-control custom-radio custom-control-inline" style="margin-top: 5px">
								<input class="custom-control-input" type="radio" name="member_gender" value="M" id="genderM" />
								<label class="custom-control-label" for="genderM">&nbsp;남자</label>&emsp;　
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input class="custom-control-input" type="radio" name="member_gender" value="F" id="genderF" />
				...
				<tr>
					<th><i class="fas fa-check"></i>&nbsp;전화번호</th>
						<td>
							<div class="form-group">
								<input class="form-control" type="text" placeholder="ex) 03180000000" name="member_phone" id="member_phone" />
					...
					<th>프로필 사진</th>
						<td>
							<div class="custom-file">
								<input class="custom-file-input" type="file" id="profileUpload" name="upProfile" accept="image/*" />
								<label class="custom-file-label" for="profileUpload"><font color="#cecece">파일을 선택해주세요.</font></label>
							</div>
						</td>
				</tr>
				<tr>
					<th>이용약관</th>
						<td>
							<div class="custom-contol custom-checkbox"style="margin-left: 2.5%">
								<input class="custom-control-input" type="checkbox" id="useCheck" />
								<label class="custom-control-label" for="useCheck">여길잡아 이용약관에 대한 동의 (필수)</label>&emsp; 
								<a href="javascript:void(0);" onclick="if(useContext.style.display == 'none') {useAllContext();} else if(useContext.style.display == 'block') {closeUseAllContext();}">전문 보기</a>
							</div>
				...
				<tr>
					<th>개인정보 수집 및 이용 동의</th>
						<td>
							<div class="custom-contol custom-checkbox"style="margin-left: 2.5%">
								<input class="custom-control-input" type="checkbox" id="userInfoCheck" />
								<label class="custom-control-label" for="userInfoCheck">개인정보 수집 및 이용 동의 (필수)</label>&emsp; 
								<a href="javascript:void(0);" onclick="if(userInfoContext.style.display == 'none') {userInfoAllContext();} else if(userInfoContext.style.display == 'block') {closeUserInfoAllContext();}">전문 보기</a>
							</div>
				...
				<tr>
					<th>만 14세 이상 확인</th>
						<td>
							<div class="custom-contol custom-checkbox"style="margin-left: 2.5%">
								<input class="custom-control-input" type="checkbox" id="ageCheck" />
								<label class="custom-control-label" for="ageCheck">만 14세 이상임을 확인합니다. (필수)</label>
							</div>
						</td>
				</tr>
				<tr><th colspan="2" style="text-align: center"><input class="btn" type="submit" id="submitBtn" value="가입하기" />&emsp;&emsp;<button class="btn" type="reset" id="cancelBtn" onclick="window.history.back();">취소</button></th></tr>										
			</table>
		</form>	
	</div>
</div>
